...
<head>
    ...
    <title>Đăng ký | Grand Elite Hotel</title>
    <!-- Tailwind CSS CDN -->
    ...
    <style>
        /* Hiệu ứng focus mượt mà và chuyển động tinh tế của nhãn */
...
<body class="font-sans bg-luxury-dark text-gray-200 min-h-screen flex items-center justify-center overflow-x-hidden">
    ...
    <div class="w-full min-h-screen flex flex-col md:flex-row shadow-2xl overflow-hidden">
        ...
        <!-- Bên trái: Hình ảnh sảnh đón tiếp sang trọng và Lời chào (Ẩn trên mobile nhỏ) -->
        <div class="relative hidden md:flex md:w-1/2 lg:w-3/5 bg-luxury-charcoal items-center justify-center overflow-hidden">
            <!-- Hình nền sảnh khách sạn tráng lệ với hiệu ứng scale mượt mà -->
            <div class="absolute inset-0 bg-cover bg-center transition-transform duration-[10000ms] hover:scale-105" 
                 style="background-image: url('https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?auto=format&fit=crop&q=80&w=1600');">
            </div>
            <!-- Lớp phủ dải màu làm tối nghệ thuật (Gradient Overlay) -->
            ...
            <div class="relative z-10 p-12 lg:p-20 flex flex-col justify-between h-full w-full max-w-2xl">
                ...
                <div class="space-y-6 mb-10">
                    ...
                    <h2 class="font-serif text-4xl lg:text-5xl leading-tight text-white font-light">
                        Khởi đầu cho hành trình <br>
                        <span class="italic text-gold-300 font-normal">Đặc Quyền</span> & <span class="font-normal">Thăng Hoa</span>
                    </h2>
        ...
        <!-- Bên phải: Form đăng ký thanh lịch -->
        <div class="w-full md:w-1/2 lg:w-2/5 bg-[#16181F] p-8 sm:p-12 lg:p-16 flex flex-col justify-between relative">
            ...
            <div class="my-auto max-w-md w-full mx-auto space-y-8">
                ...
                <div class="text-center md:text-left space-y-2">
                    <span class="text-xs uppercase tracking-[0.3em] text-gold-400 font-medium font-semibold">Thành viên mới</span>
                    <h1 class="font-serif text-3xl sm:text-4xl text-white font-light tracking-wide">Đăng Ký Khách</h1>
                    <p class="text-gray-400 text-sm">Điền thông tin để kiến tạo tài khoản đặc quyền</p>
                </div>
                ...
                <form method="POST" action="/register" class="space-y-6">
                    ...
                    <!-- Nút Đăng ký phong cách quý tộc -->
                    <button type="submit" 
                ...
                <!-- Footer liên kết: Đăng nhập / Trang chủ -->
                <div class="flex justify-between items-center text-xs tracking-wider text-gray-400 border-t border-gray-800/60 pt-6">
                    ...
                    <a href="{{ route('login') }}" class="flex items-center space-x-1.5 hover:text-gold-400 transition-all duration-300 group">
                        <span>Đã là hội viên? Đăng nhập</span>
                        <svg class="w-3.5 h-3.5 transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
